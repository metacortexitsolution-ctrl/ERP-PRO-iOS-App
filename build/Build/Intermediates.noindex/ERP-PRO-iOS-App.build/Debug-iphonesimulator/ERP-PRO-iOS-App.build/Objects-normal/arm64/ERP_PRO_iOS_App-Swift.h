...
#ifndef ERP_PRO_IOS_APP_SWIFT_H
#define ERP_PRO_IOS_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ERP_PRO_iOS_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSDate;
@interface Item (SWIFT_EXTENSION(ERP_PRO_iOS_App))
